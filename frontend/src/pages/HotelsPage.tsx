                  ...
                  <div key={hotel.id} className="hotel-card">
                    <div className="hotel-image">
                      {hotel.images && hotel.images.length > 0 ? (
                        <img src={(hotel.images[0] as any)?.thumbnail || hotel.images[0]} alt={hotel.name} />
                      ) : (
                    ...
                    <div className="hotel-info">
                      ...
                      <div className="hotel-actions">
                        <button 
                          ...
                          onClick={() => window.open(`https://www.google.com/search?q=${encodeURIComponent(hotel.name + ' Orlando booking')}`, '_blank')}
                        >
                          View Deal
                        </button>
                      </div>
